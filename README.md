...
| 文档 | 内容 |
|------|------|
| [INSTALL](doc/INSTALL.md) | 环境搭建、依赖安装、数据集准备 |
| [USER_GUIDE](doc/USER_GUIDE.md) | 训练/评估/推理/部署完整操作指南 |
| [CONFIG_GUIDE](doc/CONFIG_GUIDE.md) | 所有配置项详解与调参建议 |
| [TROUBLESHOOTING](doc/TROUBLESHOOTING.md) | 常见问题与解决方案 |
